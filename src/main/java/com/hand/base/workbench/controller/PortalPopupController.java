...
import com.hand.base.workbench.service.PopupService;
import com.hand.core.util.FileUtil;

@Controller
@RequestMapping("/action/portal/popup")
public class PortalPopupController extends BasicController<Popup> {
	@Autowired
	...
	@Override
	public BasicService<Popup> getBasicService() throws Exception {
		return popupService;
	}
	
	@RequestMapping(value = "/uploadImg", method = RequestMethod.POST)
	@ResponseBody
	public void uploadImg(Popup record, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
		...
		try{
			...
			// 将图片写到数据库
			popupService.popupImageUpdate(record, list);
