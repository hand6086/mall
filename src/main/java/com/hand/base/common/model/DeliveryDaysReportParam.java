...
public class DeliveryDaysReportParam {
	...
	public String getKHSJ_PERIOD() {
		return KHSJ_PERIOD;
	}
	public void setKHSJ_PERIOD(String kHSJ_PERIOD) {
		KHSJ_PERIOD = kHSJ_PERIOD;
	}
