...
public class ReflectUtil {
    ...
    public static void main(String[] args) {
        try {
            Class<ListOfValue> clazz = ListOfValue.class;
            /*ListOfValue listOfValue = ReflectUtil.invokeConstructor(clazz,
                    new Class<?>[]{long.class, String.class, int.class,
                            String.class, double.class}, new Object[]{1001, "Linux", 30, "123", 20.55});
            */
            ListOfValue listOfValue = ReflectUtil.invokeConstructor(clazz,
                    null, null);
            System.out.println(listOfValue);
            ReflectUtil.invokeSetter(listOfValue, "salery", 2055);
            System.out.println(listOfValue);
            /*
            Object ret = ReflectUtil.invokeGetter(listOfValue, "salery");
