...
public class CustomUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	public static final String SPRING_SECURITY_FORM_SIGNATURE_KEY = "j_signature";
	public static final String SPRING_SECURITY_FORM_CHECKNUMBER_KEY = "j_checkNumber";
	
	public static final String SPRING_SECURITY_FORM_CODE_KEY = "j_code";
	
	// session中保存的验证码
	public static final String DEFAULT_SESSION_VALIDATE_CODE_FIELD = Constants.CHECK_NUMBER_KEY;
	...
	private String checkNumberParameter = SPRING_SECURITY_FORM_CHECKNUMBER_KEY;
	private String codeParameter = SPRING_SECURITY_FORM_CODE_KEY;
	
	private String sessionvalidateCodeField = DEFAULT_SESSION_VALIDATE_CODE_FIELD;
	
	private boolean postOnly = true;
	private boolean allowEmptyValidateCode = true;//是否允许验证码为空的开关
	// ~ Constructors
	// ===================================================================================================
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		if (postOnly && !request.getMethod().equals("POST")) {
			throw new AuthenticationServiceException("请输入用户名、密码！");
		}
	...
	protected void checkValidateCode(HttpServletRequest request) {
		...
		if (StringUtils.isEmpty(checkNumber)
				|| !sessionValidateCode.equalsIgnoreCase(checkNumber)) {
	...
	private String obtainCheckNumber(HttpServletRequest request) {
	...
	public String getCheckNumberParameter() {
		return checkNumberParameter;
	}
