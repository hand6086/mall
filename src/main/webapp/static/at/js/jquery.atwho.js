...
function(jquery) {
    ...
    var $, Api, App, Controller, DEFAULT_CALLBACKS, EditableController, KEY_CODE, Model, TextareaController, View, slice = [].slice,
    ...
    Controller = (function() {
        ...
        Controller.prototype.init = function(setting) {
            this.setting = $.extend({},
            this.setting || $.fn.atwho["default"], setting);
            this.view.init();
    ...
    TextareaController = (function(superClass) {
        ...
        TextareaController.prototype.catchQuery = function() {
            ...
            if (isString && query.length <= this.getOpt('maxLen', 20)) {
				...
				//console.log("catchQuery: "+query.text);
    ...
    EditableController = (function(superClass) {
        ...
        EditableController.prototype.catchQuery = function(e) {
            ...
            if (e.which === KEY_CODE.ENTER) { ($query = $(range.startContainer).closest('.atwho-query')).contents().unwrap();
                if ($query.is(':empty')) {
                    $query.remove();
        ...
        EditableController.prototype.rect = function() {
            ...
            if (this.app.iframe && !this.app.iframeAsRoot) {
                iframeOffset = ($iframe = $(this.app.iframe)).offset();//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<当前文档
    ...
    View = (function() {
        ...
        View.prototype.bindEvent = function() {
            ...
            return $menu.on('mouseenter.atwho-view', 'li',
            function(e) {
