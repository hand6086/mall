	...
	<form id="form">
				...
				<fieldset class="fieldset">
					<div class="enter enter1">
						<input placeholder="请输入手机号码" type="text" name="phonenumber" id="phonenumber" class="entry"/>
					...
					<div class="enter enter2">
						<input placeholder="请输入手机验证码" type="text" name="VerifyCode" id="VerifyCode" class="entry entry-code"/>
			...
			$(function() {
				...
				$("#sendSMSCode").click(function() {
					...
					if(!p_phone){
						...
						if($('#form').valid()){
							$.post('<%=ctxPath%>/action/portal/storeregister/isregistered',
							{
