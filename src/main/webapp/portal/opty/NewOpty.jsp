 ...
 */
		...
		/* if (modelType != null) {
			switch (modelType) {
			case 'opty':
				noteTitle = '针对商机"' + modelName + '"的讨论';
				break;
			case 'agreement_chn':
				noteTitle = '针对国内合同"' + modelName + '"的讨论';
				break;
			case 'agreement_intel':
				noteTitle = '针对国际合同"' + modelName + '"的讨论';
				break;
			default:
				noteTitle = "";
			}
		...
		*/
		...
		function addForum() {
			...
			if($("#note").val().length==0||$("#note").val()==null||$("#note").val()==''){
				$.messager.alert("操作提示", "请输入商机跟进信息！","warning");  
				return;
			}
