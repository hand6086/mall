...
<body>
	<div class="easyui-layout" data-options="fit:true" border="false">
		<div data-options="region:'north',collapsible:false" title="商机基本信息"
			border="false" style="width: 100%; height: 280px; padding: 0px;">
					...
					<tr>
						...
						<td>
							<table>
								...
								<tr>
									<td class="td-label"><label>预计销售金额：</label></td>
									<td class="td-input"><input
						...
						<td>
							<table>
								...
								<tr>
									<td class="td-label" rowspan="4"><label>商机说明：</label></td>
			...
			<div
				style="width: 100%; height: 30px; padding: 0px; margin-top: 30px;">
				<a href="javascript:void(0)" id="btn_cancel"
					class="easyui-linkbutton" iconCls="icon-redo" plain="false"
					style="margin-left: 100px; width: 100px; height: 30px;"
					onclick="goBack()">返回</a> <a href="javascript:void(0)"
		...
		<div data-options="region:'center',split:true" border="false"
			...
			<div class="easyui-tabs" data-options="fit:true" border="false">
				...
				<div title="产品信息列表" style="height: 100%;width: 100%">
					<table id="opty-prod-table"  data-options="fit:true">
						<thead>
							<th field="prodCode" width="150px">产品编码</th>
							<th field="prodName" defaultSearch="true" width="200px">产品名称</th>
							<th field="price" currency="CNY" width="150px">单价</th>
							<th field="qty" width="80px" editor="{type:'numberspinner'}">数量</th>
			...
			<div title="商机跟进" style="height: 100%;width: 100%">
				<table id="opty-flowUp-table" data-options="fit:true">
					<thead>
						<tr>
							<th field="dt" width="160px" editor="{type:'datetimebox',options:{showSeconds:false}}">跟进时间</th>
							<th field="description" width="650px"  editor="{type:'textbox'}">跟进说明</th>
							<th field="photo" width="400px" formatter="detailFormatter">跟进照片</th>
						</tr>
 					</thead>
				</table>
			</div>
			 -->
				...
				<div title="方案报价" style="height: 100%; width: 100%">
					<table id="attachment-table" data-options="fit:true">
						<thead>
							<tr>
							<th field="attachmentOriginal" width="300px" formatter="attachmentOriginalFormatter">附件</th>
							<th field="comments" editor="{type:'textbox'}" defaultSearch="true" width="300px">方案报价</th>
							</tr>
						</thead>
					</table>
					<!-- ------------------------方案报价上传附件弹出框：开始----------------------------  -->
					<div id="upload_attachment">
						<div class="easyui-layout" data-options="fit:true">
							<div data-options="region:'center',border:false,fit:true"
								...
								<form method="post" class="uploadAttachmentForm"
									style="text-align: center; margin-top: 30px;"
									enctype="multipart/form-data" border:true>
									<!-- 							<form method="post" class="uploadAttachmentForm" style="text-align:center;  enctype="multipart/form-data" >
 -->
									<table id="uploadAttachment-table"
										...
										<tr>
											...
											<td class="td-input"><input id="openFile"
										...
										<tr>
											...
											<td class="td-input"><input id="comments"
												name="comments" class="easyui-textbox"
							...
							<div data-options="region:'south',border:false"
								style="text-align: right; padding: 5px 5px; margin-bottom: 15px"">
								<a id="btnOk" class="easyui-linkbutton upload"
									style="width: 100px; margin-right: 30px;"
									iconCls:'icon-ok'" href="javascript:void(0)"
									onclick="uploadAttachment()">上传</a> <a id="btnCancel"
									class="easyui-linkbutton"
									style="width: 100px; margin-right: 50px;"
									data-options="iconCls:'icon-cancel'" href="javascript:void(0)"
									onclick="$uploadAttachmentDiv.window('close')">取消</a>
							</div>
						</div>
					</div>
					<!-- ------------------------方案报价上传附件弹出框：结束----------------------------  -->
	...
	<script type="text/javascript">
				...
				.hdatagrid({
					...
					/* onInsertAction:function(row,successFun,errFun,that){
						...
						$.post('${AppContext.ctxPath}/action/portal/flowUp/insert',{
							optyId      : optyId,
							dt			: row.dt,              
							description	: row.description,		//商机简要	
							type        : row.type,
							orgId       : appCtx.orgId,
		...
		$dataAttachmentgrid
				.hdatagrid({
					...
					onAddMoreButton : function(that, addButtonFun) {
						if(top.deleteFlag == "Y"){
							addButtonFun(39,'<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="openUploadAttachment(\'Attachment\')">新建</a>',
									that);
						}
					},
					onUpdateAction : function(row, successFun, errFun, that) {
