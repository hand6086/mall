                ...
                <ul class="abs tc sub-msg-opr" style="margin: 0px 10px; height: 160px; width: 320px;">
                	<li>
	                    <div style="width: 320px; height: 120px; font-size: 16px;">
		                    <a class="th" href="javascript:void(0)" onclick="editDiv('div0')">编辑</a>
		                    <a class="th" href="javascript:void(0)" onclick="editDiv('div0')">保存</a>
	                    </div>
                    </li>
                </ul>
            </div>
    ...
    $("#addone").click(
            function() {
                ...
                $(".previewBox")
                        ...
                        + " onclick='removeDiv(\""
                        + msgDiv
                        + "\");return false;'> 保存 </a></div>  </li></ul> </div>");
                $("#main")
                        .append(
