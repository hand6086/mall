...
<th field="key" width="150px" lov="LNK_STANDARD_PROPERTY" editor="{type:'combobox',options:{valueField:'val',
																		textField:'name',
																		data : getLovArray('LNK_STANDARD_PROPERTY'),
																		editable:true,
																		required:true}}">参数键</th>
...
<th field="type" width="150px" align="center">公共参数</th>
...
$datagrid.hdatagrid({
	...
	onBeforeLoad: function(param){
		var code = enterpriseCode;
		if(!code){
			code = "noMatchCode";
		}
		param.filtersRaw = '[{"id":"corpid123","property":"corpid","value":"'+code+'"},{"id":"type123","property":"type","value":"N"}]'
	},
