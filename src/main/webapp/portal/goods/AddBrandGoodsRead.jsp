...
.td-content input{
										...
										<table class="table-block" >
											...
											<!-- <tr>
												<td class="td-label"><label></label></td>
								         		<td class="td-content">
								         			<a href="javascript:void(0)" style="font-size: 16px;" onclick="openProdNormsWin()">添加商品规格属性</a>
								         		</td>
								         		
								         		<td class="td-label"><label></label></td>
								         		<td class="td-content">
								         			<a href="javascript:void(0)" style="font-size: 16px;" onclick="openProdPicWin()">添加商品图片</a>
								         		</td>
											</tr> -->
    ...
    <div id="prodPicWin" class="easyui-dialog" title="商品图片" 
    	data-options="modal:true,
    		...
    		<iframe src="" id="prodPicWinForm" name="prodPicWinForm" width="100%" height="98%" frameborder="0"></iframe>
    </div>
	...
	function commitBrandGoods(){
		...
		var options = {
				...
				type : 'post',
				dataType :'json',
				data: {row_status : row_status, goodsStatus:'PENDING'},
				beforeSubmit: function() {
					var result = $brandGoodsForm.form('validate');
					return result;
				},  
	...
	function openProdNormsWin(){
		...
		$prodNormsWinForm.attr("src","${AppContext.ctxPath}/portal/goods/product/prodNormsRead.jsp?prodId="+prodId +"&goodsStatus="+goodsStatus+"&saleStatus="+saleStatus);
		$prodNormsWin.dialog('open');
	}
	
	function openProdPicWin(){
		$prodPicWinForm.attr("src","");
		$prodPicWinForm.attr("src","${AppContext.ctxPath}/portal/goods/product/productPictListRead.jsp?prodId="+prodId+"&goodsStatus="+goodsStatus+"&saleStatus="+saleStatus);
