...
<body class="easyui-layout" data-options="fit:true" border="false">
 <div data-options="region:'north',split:true" fit="true" border="false">
   <div  border="false" style="height:360px;width:100%">
	<table id="OrderEvaluation-table" fit="true"   pagination="true" >
		<thead>
			<tr>
	...
	<div  border="false" style="width:100%;height:380px;">
		<table id="WithRefundOrder-table-goods" fit="true"  pagination="true" >
			<thead>
				<tr>
