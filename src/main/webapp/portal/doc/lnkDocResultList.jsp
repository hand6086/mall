...
<body>
	<div border="false" style="height: 100%; width: 100%">
		<table id="lnkDocResult-table" style="height: 100%; width: 100%"
			fit="true">
			<thead>
				<tr>
	...
	<script type="text/javascript">
		...
		$dataresult
				.hdatagrid({
					...
					url : '${AppContext.ctxPath}/action/portal/lnkDocResult/queryByExamplePage',
					...
					onInsertOrUpdateAction : function(row, successFun, errFun,
						...
						$
								.post(
										'${AppContext.ctxPath}/action/portal/lnkDocResult/upsert',
										row, function(data) {
											if (!data.success) {
								...
								.confirm(
										...
										function(data) {
											if (data) {
												$
														.post(
																'${AppContext.ctxPath}/action/portal/lnkDocResult/deleteById',
																{
																	id : row.id
																},
																function(data) {
