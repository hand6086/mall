...
<div class="easyui-layout" data-options="fit:true" border="false">
	...
	<table id="sale-order-table" keyFilterDiv="keyFilter" fit="true" >
		<thead>
			<tr>
				...
				<th field="orderCategory" width="120px" lov="ORDER_CATEGORY">订单大类</th>
				...
				<th field="payStatus" width="60px">支付状态</th>
	...
	<script type="text/javascript">
		...
		*/
		...
		function cumulateSale(act, row) {
				$.post('${AppContext.ctxPath}/action/portal/saleorderitem/cumulateSale',
						{
							orderId : row.id,
							orderStatus : act
						}, function(data) {
