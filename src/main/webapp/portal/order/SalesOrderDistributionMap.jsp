...
<body>
	...
	<div data-options="region:'north',split:true" border="false"
		...
		<fieldset class="x-fieldset" id="keyFilter">
			...
			<div class="row keyfilter-border">
				<ul id="orderStatusKeyfilter" data-toggle="keyfilter" 
...
<script type="text/javascript">
	$('#orderTypeKeyfilter').keyFilter({
		...
		//filterByValue:true,
		dataReport:true,
		dataReportUrl:'${AppContext.ctxPath}/action/portal/saleorder/querySalesOrderOfDistrict',
		userDefined:true,
	...
	$('#orderStatusKeyfilter').keyFilter({
		remoteData:false,
	...
	$.ajax({
	    url:'${AppContext.ctxPath}/action/portal/saleorder/querySalesOrderOfDistrict',
	    type:"post",
    ...
    function loadPoints(data){
        ...
        $.each(data.rows, function(index, item) {
            var pt = {name: item.province,value: item.total };
            points.push(pt);
        });
    	var maxData;
    	if(data.rows[0] == null){
