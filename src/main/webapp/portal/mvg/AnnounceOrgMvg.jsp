...
<body style="margin:0 0 0 0">
    	<div class="easyui-layout" data-options="fit:true" border="false">
			...
			<div data-options="region:'center',split:false" border="false" style="width:6%;height:100%;">
				 ...
				 <div style="margin:0 auto;text-align:center;">
					<p><input type="button" id="addOrg" class="btn" value="&nbsp;>&nbsp;" onclick="addOrg()" title="移动选择项到右侧"/></p><br/>
					<p><input type="button" id="removeOrg" class="btn" value="&nbsp;<&nbsp;" onclick="removeOrg()" title="移动选择项到左侧"/></p>
				</div>
			</div>
		...
		function removeOrg(){
			$("#removeOrg").attr("disabled", "disabled");
