...
<body class="easyui-layout">
	<div id="p1" class="easyui-panel" collapsible="true"
		collapsed="false" border="false" style="height: 100%; padding: 0px;">
				...
				function(data){
					if(data){
						if(data.success){
							...
							$campaignApplyEditWinFram.attr("src", "${AppContext.ctxPath}/portal/brandPromotion/brandGroupApplyEdit.jsp?schemaId=" + schemaId + "&headId=" + headId);
						}
					}
			 });
