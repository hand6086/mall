	...
	<table id="flow-table"
		...
		<thead>
			<tr>
				...
				<th field="approvalNodeDesc" width="150px" editor="{type:'textbox'}">当前审批节点</th>
	...
	<script type="text/javascript">
	   ...
	   $datagrid = $('#flow-table');
		$datagrid.hdatagrid({
			...
			url:'${AppContext.ctxPath}/action/portal/flow/queryFlowPage'
		});	
		
		function idFormatter(val,row){
		     if(val != null){
		    	 var url = '${AppContext.ctxPath}/portal/approval/FlowEdit.jsp?flowId=' + row.id +'&flowObjId='+row.flowObjId;
