...
<body class="easyui-layout" data-options="fit:true" border="false">
				...
				<table style="width:100%; min-width:900px">
					...
					<tr>
						...
						<td colspan="6" rowspan="2">
				    		...
				    		plain="false" style="margin-left:70px;width: 100px;height:30px;" onclick="enableEdit()">编辑</a>
						</td>
					</tr>
					<tr>
	...
	<div id="autoconfig-tabs" class="easyui-tabs"
				...
				data-options="border:false">
		<!-- tab 对象字段 -->
		<div title="对象字段" href="${AppContext.ctxPath}/portal/lnkautoconfig/modules/FieldList.jsp"></div>
		<!-- tab 关联表 -->
