			...
			<thead>
				<tr>
					...
					<th field="attr10" width="100px"
						editor="{type:'validatebox',options:{required:false, validType:'english' }}">公司账套</th>
					<!-- 
...
<th field="attr10" width="100px" editor="{type:'validatebox',options:{required:false}}">备注10</th>
 -->
	...
	<script type="text/javascript">
		...
		$datagrid
				.hdatagrid({
					...
					onAddMoreButton : function(that, addButtonFun) {
						...
						addButtonFun(
								93,
								'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="newAppFile()" iconCls="icon-newFile" plain="true">生成对象文件</a>',
								that);/**/
						addButtonFun(
								94,
		...
		*/
		function newObject(){
			$("#editWinFram").attr("src", "${AppContext.ctxPath}/portal/lnkautoconfig/LnkObjectForMobileNew.jsp");
			$("#editWin").show();
		}
		/**
		* Form视图查看对象
		*/
		function updateObject(id){
			$("#editWinFram").attr("src", "${AppContext.ctxPath}/portal/lnkautoconfig/LnkObjectForMobileNew.jsp?op=UPDATE&id="+id);
			$("#editWin").show();
		}
