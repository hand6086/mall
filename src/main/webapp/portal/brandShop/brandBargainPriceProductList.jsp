...
<script type="text/javascript">
	...
	//新建商品
	function productAdd(){
		window.location.href="${AppContext.ctxPath}/portal/brandShop/brandBargainPriceProductEdit.jsp?headId=" + headId + "&startTime=" + "${param.startTime}" + "&endTime=" + "${param.endTime}" ;
	}
