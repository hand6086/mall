...
<body class="easyui-layout" data-options="fit:true" border="false">
	<div data-options="region:'north',split:true" fit="true" border="false">
		<div border="false" style="width: 100%; height: 357px;">
			<table id="activity-table" fit="true">
				<thead>
					<tr>
						...
						<th field="activityCode" width="120px">活动编码</th>
						...
						<th field="type" width="100px" lov='TB_O2O_CAMPAIGN_TYPE'
							editor="{type:'combobox',	
											...
											required:true,
											disabled:true}}">类型</th>
						<th field="activityNotes" width="180px"
		...
		<div border="false" style="width: 100%; height: 347px;">
			<table id="activity-table-goods" fit="true">
				<thead>
					<tr>
						<th field="buyMerchName" width="180px"
					...
					tableUrl:'${AppContext.ctxPath}/portal/picklist/Tbo2oMerchandisePickList.jsp'}}">购买商品名称</th>
						<th field="buyAmt" width="100px"
							editor="{type:'textbox',options:{required:true}}">购买数量</th>
						<th field="freeMerchName" width="180px"
							editor="{type:'picklistbox',options:{required:true,title:'选择商品',
					      completeFun:freeMerchNamePicklistComplete,initParam:initPickfreeGoodsParam,
					tableUrl:'${AppContext.ctxPath}/portal/picklist/Tbo2oMerchandisePickList.jsp'}}">赠送商品名称</th>
						<th field="freeAmt" width="100px" 
							editor="{type:'numberbox',options:{
																min:0,
																precision:0,
																required:true}}">赠送数量</th>
						<th field="lmtAmt" width="100px"
							editor="{type:'numberbox',options:{
																min:0,
																precision:0,
																required:true}}">单人限赠数量</th>										
						<th field="totalQty" width="100px"
							editor="{type:'numberbox',options:{
																min:0,
																precision:0,
																required:true}}">限赠总量</th>
						<th field="purchasedQty" width="100px"
							>已赠数量</th>
	...
	<script type="text/javascript">
		...
		$dataItemgrid.hdatagrid({
			...
			subGridIds : [ 'activity-table-goods' ],
			...
			onInsertOrUpdateAction:function(row,successFun,errFun,that){
				 var startTime= $dataItemgrid.hdatagrid('getCurrentRow').startTime;
				var  endTime= $dataItemgrid.hdatagrid('getCurrentRow').endTime;
		...
		function freeMerchNamePicklistComplete(selectRow){
			$dataItemgoods.hdatagrid('getCurrentRow').freeMerchId = selectRow.id;
			return selectRow.o2oDisplayName;
		}
		...
		function initPickfreeGoodsParam() {
			var row = $dataItemgrid.hdatagrid('getCurrentRow');
			var attr1 = 'free';
			return {attr1:attr1,districtId:row.cityId};
		}
