...
<body>
<table id="noArrivalDetails-table" fit="true" rownumbers="true" pagination="true">
			<thead>
			<tr>
			<th field="receiptCode" width="100px" >单据编号</th>
			<th field="receiptType" width="100px"value="订单">单据类型</th>
...
var $datagrid = $("#noArrivalDetails-table");
...
$datagrid.hdatagrid({
	...
	url :'${AppContext.ctxPath}/action/portal/unintoaccount/queryByExamplePage',
