...
<body>
   ...
   <fieldset class="x-fieldset" id="goodsbrowsingKeyFilter">
   ...
   <table id="goods-browsing-table" singleSelect="true" rownumbers="true"  pagination="true" fit="true" keyFilterDiv="goodsbrowsingKeyFilter">
		<thead>
			<tr>
				<th field="goodsName" width="200px">商品名称</th>
				<th field="pV" width="100px">商品访问次数</th>
				<th field="uV" width="150px">去重商品访问次数</th>
	...
	<script type="text/javascript">
		...
		$datagrid.hdatagrid({
			...
			nowrap:false, //换行
			border:false,
			url:'${AppContext.ctxPath}/action/portal/goodsBrowsingAnalysis/queryByExamplePage',
			...
			onBeforeLoad:function(param){
 			 ...
 			 onAddMoreButton:function(that,addButtonFun){
 				addButtonFun(1,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="goodsBrowsingSearch()" iconCls="icon-search" plain="true">查询</a>',that);
 				addButtonFun(2,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="goodsBrowsingClean()" iconCls="icon-reload" plain="true">重置</a>',that);
 			 } 
		});
