	...
	<div class="easyui-layout" data-options="fit:true" border="false">
		<div data-options="region:'center'" title="" style="width: 100%; height: 100%; padding: 0px;">
			<div id="header" class="easyui-panel" style="height:100%" title="报表参数">
				<form method="post" id="queryRePurchaseReport" action="/action/portal/chart/queryRePurchaseReport">
					<br/>
						...
						<tr>
							<td>
								<table class="table-block" >
									<tr>
										<td class="td-label"><label>截止日期 :</label></td>
										<td class="td-content">
