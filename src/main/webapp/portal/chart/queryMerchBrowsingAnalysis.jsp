...
<body>
   ...
   <fieldset class="x-fieldset" id="merchBrowsingKeyFilter">
   ...
   <table id="merch-Browsing-table" singleSelect="true" rownumbers="true"  pagination="true" fit="true" keyFilterDiv="merchBrowsingKeyFilter">
		<thead>
			<tr>
				<th field="merchName" width="180px">商家名称</th>
				<th field="pV" width="100px">商家访问量</th>
				<th field="uV" width="100px">去重商家访问量</th>
	...
	<script type="text/javascript">
		...
		$datagrid.hdatagrid({
			...
			nowrap:false, //换行
			border:false,
			url:'${AppContext.ctxPath}/action/portal/merchBrowsingAnalysis/queryByExamplePage',
			...
			onBeforeLoad:function(param){
 			 ...
 			 onAddMoreButton:function(that,addButtonFun){
 				addButtonFun(1,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="merchBrowsingSearch()" iconCls="icon-search" plain="true">查询</a>',that);
 				addButtonFun(2,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="merchBrowsingClean()" iconCls="icon-reload" plain="true">重置</a>',that);
 			 } 
		});
		
		function merchBrowsingSearch(){
		   	startTime = $('#startTime').datetimebox('getValue');
		   	endTime = $('#endTime').datetimebox('getValue');
