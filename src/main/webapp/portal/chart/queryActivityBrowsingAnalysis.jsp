...
<div  class="easyui-layout" data-options="fit:true" border="false">
   ...
   <fieldset class="x-fieldset" id="activityBrowsingKeyFilter">
   ...
   <table id="activity-browsing-table" singleSelect="true" rownumbers="true"  pagination="true" fit="true" keyFilterDiv="activityBrowsingKeyFilter">
		<thead>
			<tr>
				<th field="activityName" width="200px">活动名称</th>
				<th field="pV" width="100px">活动访问次数</th>
				<th field="uV" width="150px">去重活动访问次数</th>
	...
	<script type="text/javascript">
	    ...
	    $datagrid = $('#activity-browsing-table');
		$datagrid.hdatagrid({
			updateable:false,
			toolbarShow:true,
			buttonSearch:false,
			...
			nowrap:false, //换行
			border:false,
			url:'${AppContext.ctxPath}/action/portal/activityBrowsingAnalysis/queryByExamplePage',
			...
			onBeforeLoad:function(param){
 			 ...
 			 onAddMoreButton:function(that,addButtonFun){
 				addButtonFun(1,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="activityBrowsingSearch()" iconCls="icon-search" plain="true">查询</a>',that);
 				addButtonFun(2,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="activityBrowsingClean()" iconCls="icon-reload" plain="true">重置</a>',that);
 			 } 
		});
		...
		function activityBrowsingSearch(){
		...
		function activityBrowsingClean(){
