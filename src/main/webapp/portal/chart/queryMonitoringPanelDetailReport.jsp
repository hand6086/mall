	...
	<div class="easyui-layout" data-options="fit:true" border="false">
		<div data-options="region:'center'" title="" style="width: 100%; height: 100%; padding: 0px;">
			<div id="header" class="easyui-panel" style="height:100%" title="报表参数">
				<form method="post" id="queryMonitoringPanelDetailReportForm" action="/action/portal/chart/queryMonitoringPanelDetailReport">
					<br/>
					<table class="form-table">
						...
						<tr>
							...
							<td>
								<table class="table-block" >
									<tr>
										<td class="td-label"><label>订单筛选 :</label></td>
										<td class="td-content">
											<input  class="easyui-combobox" type="text" id="STATUS_ZB" name="STATUS_ZB" />
										</td>
									</tr>
								</table>
							</td>
...
window.onload = function () { 
	...
	var data = $('#STATUS_ZB').combobox('getData');
...
$STATUS_ZB.combobox({
	valueField:'val',
	textField:'name',
	url:'/action/portal/basic/list/TB_REPORD_ORDERSTATUS',
	editable:false,
	cache : false,
	onSelect : function() {
	},
...
function thisFormSubmit(){
	...
	var d1 = new Date(DATE_FROM.replace(/\-/g, "\/"));  
	 ...
	 $('#queryMonitoringPanelDetailReportForm').submit(); 
