...
<div  class="easyui-layout" data-options="fit:true" border="false">
   ...
   <fieldset class="x-fieldset" id="goodsSalesKeyFilter">
   ...
   <table id="goods-sales-table" singleSelect="true" rownumbers="true"  pagination="true" fit="true" keyFilterDiv="goodsSalesKeyFilter">
		<thead>
			<tr>
				<th field="merchName" width="150px">商家名称</th>
				<th field="goodsName" width="150px">商品名称</th>
				<th field="saleNumber" width="150px">销量</th>
				<th field="saleMoney" width="150px">销售额</th>
				<th field="dealMoney" width="150px">实际成交金额</th>
			</tr>
		</thead>
	</table>
	</div>
	...
	<script type="text/javascript">
		...
		$datagrid.hdatagrid({
			...
			nowrap:false, //换行
			border:false,
			url:'${AppContext.ctxPath}/action/portal/brandMerchGoodsSalesAnalysis/queryByExamplePage',
			...
			onBeforeLoad:function(param){
 			 ...
 			 onAddMoreButton:function(that,addButtonFun){
 				addButtonFun(1,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="goodsSalesSearch()" iconCls="icon-search" plain="true">查询</a>',that);
 				addButtonFun(2,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="goodsSalesClean()" iconCls="icon-reload" plain="true">重置</a>',that);
 			 } 
		});
		
		function goodsSalesSearch(){
