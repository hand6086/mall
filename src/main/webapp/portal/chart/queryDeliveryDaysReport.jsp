	...
	<div class="easyui-layout" data-options="fit:true" border="false">
		<div data-options="region:'center'" title="" style="width: 100%; height: 100%; padding: 0px;">
			<div id="header" class="easyui-panel" style="height:100%" title="报表参数">
				<form method="post" id="queryDeliveryDaysReport" action="/action/portal/chart/queryDeliveryDaysReport">
					<br/>
					<table class="form-table">
						...
						<tr>
							...
							<td>
								<table class="table-block" >
									<tr>
										<td class="td-label"><label>考核时间点：</label></td>
									<td class="td-content">
											<input type="text" value='00' list="itemlist" name="KHSJ_PERIOD" id="KHSJ_PERIOD">
...
function thisFormSubmit(){
	...
	var d1 = new Date(DATE_FROM.replace(/\-/g, "\/"));  
	 ...
	 $('#queryDeliveryDaysReport').submit(); 
