	...
	<div class="easyui-layout" data-options="fit:true" border="false">
		<div data-options="region:'center'" title="" style="width: 100%; height: 100%; padding: 0px;">
			<div id="header" class="easyui-panel" style="height:100%" title="报表参数">
				<form method="post" id="queryMerchSettleBatchQueryReportForm" action="/action/portal/chart/queryMerchSettleBatchQueryReport">
					<br/>
							...
							<td>
								<table class="table-block" >
									<tr>
										...
										<td class="td-content">
											<input    class="easyui-combobox" type="text" id="SETTLE_STATUS" name="SETTLE_STATUS"  />
										</td>
									</tr>
								</table>
							</td>
...
$SETTLE_STATUS.combobox({
	valueField:'val',
	textField:'name',
	url:'/action/portal/basic/list/TB_O2O_SETTLEMENT_STATUS',
	editable:false,
	cache : false,
	onSelect : function() {
	},
...
function thisFormSubmit(){
	...
	var d1 = new Date(DATE_FROM.replace(/\-/g, "\/"));  
	 ...
	 $('#queryMerchSettleBatchQueryReportForm').submit(); 
