...
<body>
   ...
   <fieldset class="x-fieldset" id="merchPaymentConversionKeyFilter">
   ...
   <table id="merch-payment-conversion-table" singleSelect="true" rownumbers="true"  pagination="true" fit="true" keyFilterDiv="merchPaymentConversionKeyFilter">
		<thead>
			<tr>
	...
	<script type="text/javascript">
	    ...
	    $datagrid = $('#merch-payment-conversion-table');
		$datagrid.hdatagrid({
			updateable:false,
			toolbarShow:true,
			buttonSearch:false,
			...
			nowrap:false, //换行
			border:false,
			url:'${AppContext.ctxPath}/action/portal/merchPaymentConversion/queryByExamplePage',
			...
			onBeforeLoad:function(param){
 			 ...
 			 onAddMoreButton:function(that,addButtonFun){
 				addButtonFun(1,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="merchPaymentSearch()" iconCls="icon-search" plain="true">查询</a>',that);
 				addButtonFun(2,'<a href="javascript:void(0)" class="easyui-linkbutton" onClick="merchPaymentClean()" iconCls="icon-reload" plain="true">重置</a>',that);
 			 } 
		});
		
		function merchPaymentSearch(){
		   	startTime = $('#startTime').datetimebox('getValue');
		   	endTime = $('#endTime').datetimebox('getValue');
