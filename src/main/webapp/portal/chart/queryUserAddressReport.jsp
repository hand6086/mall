   ...
   <table id="brand-goods-table"
	...
	<script type="text/javascript">
		...
		$datagrid.hdatagrid({
			...
			nowrap:false,
			border:false,
			url:'${AppContext.ctxPath}/action/portal/useraddress/queryByExamplePage',
		...
		$O2O_CITYPicklist.picklist({
			...
			completeFun:function (selectRow){
				...
				return selectRow.parentName;
			}
		});
		
		function paramSearch(){
			
		  province = $("#province").picklist('getValue');
		   startTime = $('#startTime').datetimebox('getValue');
		   endTime = $('#endTime').datetimebox('getValue');
