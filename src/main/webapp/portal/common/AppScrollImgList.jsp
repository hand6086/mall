		...
		<table id="scrollImg-table" fit="true">
			<thead>
				<tr>
					...
					<th field="seq" width="100px" editor="{type:'numberbox',options:{min:0,required:true}}">顺序</th>
	...
	<script type="text/javascript">
		...
		$datagrid.hdatagrid({
			...
			onAddMoreButton:function(that,addButtonFun){
				addButtonFun(91,'<div style = "width:78px;display:inline-block"> <form id="form" method="post" enctype="multipart/form-data"> <a href="javascript:;" class="file easyui-linkbutton fileImg" iconCls="icon-uploadImg" plain="true">上传图片 <input type="hidden" id="entityId" name="id"/>'+"<input type='hidden' name='method' value='upload'/><input type='file' id='file' name='myfile'/></a></form></div>",that);
			},
