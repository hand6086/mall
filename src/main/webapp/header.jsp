	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				//加载分类
					$.post(
						"${pageContext.request.contextPath }/action/portal/category/queryAllCategory",
						function(data){
							if(data.success){
								var content="";
								for(var i=0;i<data.rows.length;i++){
										content+=" <li><a href='${pageContext.request.contextPath }/product?method=productListCid&cid="+data.rows[i].cid+"'>"+data.rows[i].cname+"</a></li>";
								}
